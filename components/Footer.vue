    ...
    <div id="FooterMain" class="w-full bg-[#E8E8E8] mt-10 mb-2">
        <div class="max-w-[1200px] mx-auto px-4">
            <div class="md:flex gap-4 justify-between w-full">
                ...
                <div class="md:w-[50%] pt-4">
                    <div class="text-lg font-semibold text-[#282828]">GoodShop Multi-Language Sites</div>
            ...
            <div class="md:flex gap-4 justify-between w-full">
                ...
                <div class="md:w-[50%] pt-4">
                    <div class="text-lg font-semibold text-[#282828]">GoodShop Group</div>
                    <div class="text-[#999999] text-sm">Group Website, Alimama, Alipay, Fliggy, Alibaba Cloud, Alibaba International, AliTelecom, DingTalk, Juhuasuan, Taobao Marketplace, Tmall, Taobao Global, AliOS, 1688</div>
                </div>
            </div>
        </div>
    </div>
